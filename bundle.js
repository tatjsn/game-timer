...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2.default // lets us dispatch() from actions
	)(_redux.createStore);
	...
	var decodeAudioData = function decodeAudioData(context) {
	...
	var createBufferSource = function createBufferSource(context) {
	...
	var decode = decodeAudioData(audioCtx);
	var createSource = createBufferSource(audioCtx);

	var fetchAac = function fetchAac(url) {
	...
	var radio = undefined,
	    ching = undefined; // buffers
	var radioSource = undefined,
	    chingSource = undefined;
	Promise.all(['./radio.aac', './ching.aac'].map(fetchAac)).then(function (_ref) {
	  var _ref2 = _slicedToArray(_ref, 2);

	  var radioBuffer = _ref2[0];
	  var chingBuffer = _ref2[1];

	  radio = radioBuffer;
	  ching = chingBuffer;
	  store.dispatch((0, _actions.soundsReady)());
	});

	var playChing = function playChing(duration) {
	  if (ching) {
	...
	var isRunning = _store$getState.isRunning;
	var time = _store$getState.time;
	...
	store.subscribe(function () {
	  ...
	  isRunning = _store$getState2.isRunning;
	  time = _store$getState2.time;


	  if (time !== prevTime && time === 0 && isRunning) {
	    // Game over
	    clearInterval(intervalId);
	    store.dispatch((0, _actions.gamePause)());
	    playChing(10 * 1000);
	    setTimeout(function () {
	      store.dispatch((0, _actions.gameOver)());
	    }, 10 * 1000);
	    return;
	  }
	  ...
	  if (isRunning !== prevIsRunning) {
	    if (isRunning && intervalId === undefined) {
	      ...
	      intervalId = setInterval(function () {
	        store.dispatch((0, _actions.timeDecrease)(1));
	      }, 1000);
	...
	var appParams = {
	  onTimeSet: function onTimeSet(value) {
	    return store.dispatch((0, _actions.timeInitalize)(value));
	  },
	  onResume: function onResume() {
	    return store.dispatch((0, _actions.gameResume)());
	  },
	  onPause: function onPause() {
	    return store.dispatch((0, _actions.gamePause)());
	  }
	};

	var VisibleApp = (0, _reactRedux.connect)(function (_ref3) {
	  var isTimeSet = _ref3.isTimeSet;
	  return { isTimeSet: isTimeSet };
	})(_App2.default);

	(0, _reactDom.render)(_react2.default.createElement(
	  _reactRedux.Provider,
	  { store: store },
	  _react2.default.createElement(VisibleApp, appParams)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var time = function time() {
	  ...
	  switch (type) {
	    case _actions.TIME_INITIALIZE:
	      return payload;
	    case _actions.TIME_DECREASE:
	...
	var isTimeSet = function isTimeSet() {
	...
	var isRunning = function isRunning() {
	  ...
	  switch (type) {
	    case _actions.GAME_RESUME:
	      return true;
	    case _actions.GAME_PAUSE:
	      return false;
	    default:
	      return state;
	  }
...
/***/ function(module, exports) {
	...
	var TIME_INITIALIZE = exports.TIME_INITIALIZE = 'TIME_INITIALIZE';
	var TIME_DECREASE = exports.TIME_DECREASE = 'TIME_DECREASE';
	var GAME_RESUME = exports.GAME_RESUME = 'GAME_RESUME';
	var GAME_PAUSE = exports.GAME_PAUSE = 'GAME_PAUSE';
	var GAME_OVER = exports.GAME_OVER = 'GAME_OVER';
	var SOUNDS_READY = exports.SOUNDS_READY = 'SOUNDS_READY';

	var parseDec = function parseDec(value) {
	  return +value;
	};

	var valueToTime = function valueToTime(value) {
	  var numbers = value.split('').map(parseDec);
	  var result = 0;
	  var i = 0;
	  var num = undefined;
	...
	var timeInitalize = exports.timeInitalize = function timeInitalize(value) {
	  return { type: TIME_INITIALIZE, payload: valueToTime(value) };
	};
	var timeDecrease = exports.timeDecrease = function timeDecrease(value) {
	  return { type: TIME_DECREASE, payload: value };
	};
	var gameResume = exports.gameResume = function gameResume() {
	  return { type: GAME_RESUME };
	};
	var gamePause = exports.gamePause = function gamePause() {
	  return { type: GAME_PAUSE };
	};
	var gameOver = exports.gameOver = function gameOver() {
	  return { type: GAME_OVER };
	};
	var soundsReady = exports.soundsReady = function soundsReady() {
	  return { type: SOUNDS_READY };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Time = __webpack_require__(374);
	...
	var _ControlPanel = __webpack_require__(376);
	...
	var VisibleInput = (0, _reactRedux.connect)(function (_ref) {
	  var inGame = _ref.inGame;
	  return { inGame: inGame };
	})(_Input2.default);
	var VisibleTime = (0, _reactRedux.connect)(function (_ref2) {
	  var time = _ref2.time;
	  return { time: time };
	})(_Time2.default);
	var VisibleControlPanel = (0, _reactRedux.connect)(function (_ref3) {
	  var isRunning = _ref3.isRunning;
	  var isReady = _ref3.isReady;
	  var isTimeSet = _ref3.isTimeSet;
	  return { isRunning: isRunning, isReady: isReady, isTimeSet: isTimeSet };
	})(_ControlPanel2.default);

	exports.default = function (_ref4) {
	  var isTimeSet = _ref4.isTimeSet;
	  var onTimeSet = _ref4.onTimeSet;
	  var onResume = _ref4.onResume;
	  var onPause = _ref4.onPause;
	  return _react2.default.createElement(
	    'div',
	    { className: 'container m-t-3' },
	    isTimeSet ? _react2.default.createElement(VisibleTime, null) : _react2.default.createElement(VisibleInput, { onTimeSet: onTimeSet }),
	    _react2.default.createElement(VisibleControlPanel, { onResume: onResume, onPause: onPause })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var normalizeTime = function normalizeTime(num) {
	  return (num > 9 ? '' : '0') + num;
	};
	...
	exports.default = function (_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'p',
	      { className: 'display-2 text-xs-center' },
	      normalizeTime(Math.floor(time / 60)),
	      ':',
	      normalizeTime(time % 60)
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var callTimeSet = function callTimeSet(onTimeSet) {
	...
	exports.default = function (_ref) {
	  var onTimeSet = _ref.onTimeSet;
	  return _react2.default.createElement(
	    "div",
	    null,
	    _react2.default.createElement("input", { type: "number", pattern: "\\d*", className: "form-control form-control-lg text-xs-center p-y-3", placeholder: "じかん", onBlur: callTimeSet(onTimeSet) })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  ...
	  var isTimeSet = _ref.isTimeSet;
	  return _react2.default.createElement(
	    "div",
	    { className: "m-t-3" },
	    isRunning ? _react2.default.createElement(
	      "button",
	      { type: "button", className: "btn btn-danger btn-lg btn-block p-y-3", onClick: onPause, disabled: !(isReady && isTimeSet) },
	      "まった！"
	    ) : _react2.default.createElement(
	      "button",
	      { type: "button", className: "btn btn-primary btn-lg btn-block p-y-3", onClick: onResume, disabled: !(isReady && isTimeSet) },
	      "さいかい"
	    )
	  );
	};
