...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ControlPanel = __webpack_require__(375);
	...
	var inGame = _store$getState.inGame;
	var inTimeout = _store$getState.inTimeout;
	var time = _store$getState.time;

	var intervalId = undefined;
	store.subscribe(function () {
	  var prevInGame = inGame;
	  var prevInTimeout = inTimeout;
	  var prevTime = time;

	  var _store$getState2 = store.getState();

	  inGame = _store$getState2.inGame;
	  inTimeout = _store$getState2.inTimeout;
	  time = _store$getState2.time;

	  if (time !== prevTime && time === 0 && inGame && !inTimeout) {
	    clearInterval(intervalId);
	    store.dispatch((0, _actions.gameEnd)());
	    if (ching) {
	...
	var VisibleInput = (0, _reactRedux.connect)(function (_ref3) {
	  var inGame = _ref3.inGame;
	  return { inGame: inGame };
	})(_Input2.default);
	var VisibleTime = (0, _reactRedux.connect)(function (_ref4) {
	  var time = _ref4.time;
	  return { time: time };
	})(_Time2.default);
	var VisibleControlPanel = (0, _reactRedux.connect)(function (_ref5) {
	  var inGame = _ref5.inGame;
	  var inTimeout = _ref5.inTimeout;
	  return { inGame: inGame, inTimeout: inTimeout };
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(VisibleTime, null),
	    _react2.default.createElement(VisibleInput, { onChange: function onChange(event) {
	        return store.dispatch((0, _actions.timeInitalize)(event.target.value));
	      } }),
	    _react2.default.createElement(VisibleControlPanel, {
	      onBegin: function onBegin(event) {
	        return store.dispatch((0, _actions.gameBegin)(store.getState().gameTime));
	      },
	      onEnd: function onEnd(event) {
	        return store.dispatch((0, _actions.gameEnd)());
	      },
	      onPause: function onPause(event) {
	        return store.dispatch((0, _actions.timeoutBegin)());
	      },
	      onResume: function onResume(event) {
	        return store.dispatch((0, _actions.timeoutEnd)());
	      } })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inTimeout = function inTimeout() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
	  var _ref4 = arguments[1];
	  var type = _ref4.type;

	  switch (type) {
	    case _actions.TIMEOUT_BEGIN:
	      return true;
	    case _actions.TIMEOUT_END:
	      return false;
	    default:
	      return state;
	  }
...
/***/ function(module, exports) {
	...
	var GAME_BEGIN = exports.GAME_BEGIN = 'GAME_BEGIN';
	var GAME_END = exports.GAME_END = 'GAME_END';
	var TIMEOUT_BEGIN = exports.TIMEOUT_BEGIN = 'TIMEOUT_BEGIN';
	var TIMEOUT_END = exports.TIMEOUT_END = 'TIMEOUT_END';
	...
	var gameBegin = exports.gameBegin = function gameBegin(value) {
	  return { type: GAME_BEGIN, payload: value };
	};
	var gameEnd = exports.gameEnd = function gameEnd(value) {
	  return { type: GAME_END };
	};
	var timeoutBegin = exports.timeoutBegin = function timeoutBegin(value) {
	  return { type: TIMEOUT_BEGIN };
	};
	var timeoutEnd = exports.timeoutEnd = function timeoutEnd(value) {
	  return { type: TIMEOUT_END };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  ...
	  return _react2.default.createElement(
	    "div",
	    null,
	    _react2.default.createElement("input", { type: "text", value: input, onChange: onChange, disabled: inGame })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  var onBegin = _ref.onBegin;
	  var onEnd = _ref.onEnd;
	  var onPause = _ref.onPause;
	  var onResume = _ref.onResume;
	  var inGame = _ref.inGame;
	  var inTimeout = _ref.inTimeout;
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(
	      'button',
	      { onClick: onBegin, disabled: inGame },
	      'Begin'
	    ),
	    _react2.default.createElement(
	      'button',
	      { onClick: onEnd, disabled: !inGame },
	      'End'
	    ),
	    _react2.default.createElement(
	      'button',
	      { onClick: onPause, disabled: !inGame || inTimeout },
	      'Pause'
	    ),
	    _react2.default.createElement(
	      'button',
	      { onClick: onResume, disabled: !inGame || !inTimeout },
	      'Resume'
	    )
	  );
	};
